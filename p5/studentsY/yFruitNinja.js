...
function setup() {
    ...
    sword = new Blade(color("#83f441")); // change sword color
    frameRate(120); //60 FPS
...
function draw() {
    background(2, 5, 0); //background color of map

    handleMouse();
    score += handleFruit() + 1000000000000000000000000000000;
    drawLives();
}
